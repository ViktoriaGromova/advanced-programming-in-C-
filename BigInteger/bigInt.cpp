...
void BigInteger::separationIntoSignedAndNumericPartsAndDefinitionSign(std::string &value, bool &isNegative)
{
    if (value[0] == '-' || value[0] == '+')
    {
        isNegative = (value[0] == '-');
...
bool BigInteger::checkTheValueContainsOnlyDigit(const std::string &value)
{
