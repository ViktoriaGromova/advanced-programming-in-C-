...
int main(){
    ...
    // Однако с Granny не получится, так как их две. Решение - постпенный каст, в котором указывается к кому кастуется
    Dad& d1= reinterpret_cast<Dad&>(s); // тут будет неправильный каст и будет ссылка на маму
    return 0;
}